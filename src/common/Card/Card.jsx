...
const Card = () => {
  ...
  const addCorzina = () => {
    ...
    setProdBalance(prev => prev + price)
  }
  return (
    <div className='card'>        
        <Link to={'/singleproduct'} className="card-header">
          <img src="./images/product.png" alt="product" />
        </Link>
        <Link to={'/singleproduct'} className="card-body">
            <h4 className="card-title">
              AOS <b>Ср-во для мытья посуды Апельсин+мята
              </b>
            </h4>
        ...
        <div className="card-footer">
          ...
          <button type='button' onClick={addCorzina} className='to-corzina'>
            В КОРЗИНУ
            <span>
